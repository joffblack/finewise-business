...
export function SidebarLayout({ navbar, sidebar, children }) {
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full bg-white max-lg:flex-col lg:bg-[#0F2128] lg:background-color: #f03232 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      {/* Sidebar on desktop */}
